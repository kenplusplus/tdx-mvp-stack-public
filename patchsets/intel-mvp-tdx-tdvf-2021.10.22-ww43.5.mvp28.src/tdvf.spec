...
cp Build/OvmfX64/DEBUG_GCC*/FV/OVMF.fd %{buildroot}/usr/share/qemu/TDVF-debug.fd
cp Build/OvmfX64/RELEASE_GCC*/FV/OVMF.fd %{buildroot}/usr/share/qemu/TDVF.fd
cp Build/OvmfX64/RELEASE_GCC*/X64/DumpTdxEventLog.efi %{buildroot}/usr/share/qemu/DumpTdxEventLog.efi

%files
%license License.txt
/usr/share/qemu/TDVF-debug.fd
/usr/share/qemu/TDVF.fd
