...
%define downstream_tag 2021.10.27

%if %{rcver}
%global distro_build 0.rc%{rcver}.%{downstream_tag}.%{relver}
%else
%global distro_build 0.%{downstream_tag}.%{relver}
%endif
...
# Control whether we perform a compat. check against DUP ABI. (disabled)
...
%global adp_prefix intel-mvp-tdx-host-
...
Provides: tdx-host-kernel
Obsoletes: tdx-host-kernel
...
Source0: https://github.com/torvalds/linux/archive/refs/tags/v5.12-rc2.tar.gz
Source1: %{source_url_prefix}/Makefile.rhelver
Source2: patches-tdx-host-kernel-5.12-rc%{rcver}-%{downstream_tag}.tar.gz
...
Source57: kernel-x86_64-spr-rhel.config
#Source58: %{source_url_prefix}/kernel-x86_64-icx-rhel.config
