...
%define source_url_prefix https://git.centos.org/rpms/qemu-kvm/raw/c8-stream-rhel/f/SOURCES
...
../configure  \
 ...
 --extra-cflags="%{optflags} -Wno-error=maybe-uninitialized" \
